...
```
```{r}
vir1 <- ggplot(vir1_polya_length_change, aes(x = wass_dir)) +
...
```{r}
ggsave(
  filename = "../../Figures/figure_2/all_vir1_polya_length_changes.pdf",
  plot = vir1,
  width = 6, height = 5, units = "in" 
)
ggsave(
  filename = "../../Figures/figure_2/all_vir1_polya_length_changes.png",
  plot = vir1,
  width = 6, height = 5, units = "in" 
)
```
...
```{r}
flacc <- ggplot(flacc_polya_length_change, aes(x=wass_dir)) +
...
```{r}
ggsave(
  filename = "../../Figures/figure_2/all_hiz2_4_polya_length_changes.pdf",
  plot = flacc,
  width = 6, height = 5, units = "in" 
)
ggsave(
  filename = "../../Figures/figure_2/all_hiz2_4_polya_length_changes.png",
  plot = flacc,
  width = 6, height = 5, units = "in" 
)
```
...
```{r}
fip <- ggplot(fip37_polya_length_change, aes(x=wass_dir)) +
...
```
```{r}
ect <- ggplot(ect_polya_length_change, aes(x=wass_dir)) +
