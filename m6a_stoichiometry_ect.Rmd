...
files <- c("col0_8_2", "col0_8_4",
                "alkbh10b_1", "alkbh10b_2","alkbh10b_3","alkbh10b_4",
                "alkbh10c_1", "alkbh10c_2","alkbh10c_3","alkbh10c_4",
                "vir1_8_1", "vir1_8_2","vir1_8_3","vir1_8_4")
...
colnames(samples_all) <- c(
    ...
    "n_reads.col0_8_2",   "probability_modified.col0_8_2", "kmer", "mod_ratio.col0_8_2",
    "n_reads.col0_8_4",  "probability_modified.col0_8_4",  "mod_ratio.col0_8_4",
    "n_reads.alkbh10b_1", "probability_modified.alkbh10b_1", "mod_ratio.alkbh10b_1",
    "n_reads.alkbh10b_2", "probability_modified.alkbh10b_2", "mod_ratio.alkbh10b_2",
    "n_reads.alkbh10b_3", "probability_modified.alkbh10b_3", "mod_ratio.alkbh10b_3",
    "n_reads.alkbh10b_4", "probability_modified.alkbh10b_4", "mod_ratio.alkbh10b_4",
    "n_reads.alkbh10c_1", "probability_modified.alkbh10c_1", "mod_ratio.alkbh10c_1",
    "n_reads.alkbh10c_2", "probability_modified.alkbh10c_2", "mod_ratio.alkbh10c_2",
    "n_reads.alkbh10c_3", "probability_modified.alkbh10c_3", "mod_ratio.alkbh10c_3",
    "n_reads.alkbh10c_4", "probability_modified.alkbh10c_4", "mod_ratio.alkbh10c_4",
    "n_reads.vir1_8_1",   "probability_modified.vir1_8_1",   "mod_ratio.vir1_8_1",
    "n_reads.vir1_8_2",   "probability_modified.vir1_8_2",   "mod_ratio.vir1_8_2",
    "n_reads.vir1_8_3",   "probability_modified.vir1_8_3",   "mod_ratio.vir1_8_3",
    "n_reads.vir1_8_4",   "probability_modified.vir1_8_4",   "mod_ratio.vir1_8_4"
)
```
Sites which have predicted m6A in col0
```{r}
sites <- samples_all[!is.na(samples_all$mod_ratio.col0_8_2) | !is.na(samples_all$mod_ratio.col0_8_4) | 
                    !is.na(samples_all$mod_ratio.alkbh10b_1) | !is.na(samples_all$mod_ratio.alkbh10b_2) |
                    !is.na(samples_all$mod_ratio.alkbh10b_3) | !is.na(samples_all$mod_ratio.alkbh10b_4),]
```
...
alkbh10b <- dplyr::select(sites, 
                          mod_ratio.alkbh10b_1, 
                          mod_ratio.alkbh10b_2, 
                          mod_ratio.alkbh10b_3, 
                          mod_ratio.alkbh10b_4)

alkbh10c <- dplyr::select(sites, 
                          mod_ratio.alkbh10c_1, 
                          mod_ratio.alkbh10c_2, 
                          mod_ratio.alkbh10c_3, 
                          mod_ratio.alkbh10c_4)

vir1   <- dplyr::select(sites, 
                          mod_ratio.vir1_8_1, 
                          mod_ratio.vir1_8_2, 
                          mod_ratio.vir1_8_3, 
                          mod_ratio.vir1_8_4)
...
df <- rbind(
    ...
    data.frame(genotype="alkbh10b", reshape2::melt(alkbh10b)),
    data.frame(genotype="alkbh10c", reshape2::melt(alkbh10c)),
    data.frame(genotype="vir1", reshape2::melt(vir1))
)
```
```{r}
custom_colors <- c(
...
```{r}
ggsave(
  filename = "../../Figures/figure_7/alkbh10_m6anet.pdf",
  plot = m6a_plot,
  width = 5, height = 4, units = "in"
)
ggsave(
  filename = "../../Figures/figure_7/alkbh10_m6anet.png",
  plot = m6a_plot,
  width = 5, height = 4, units = "in" 
)
```
