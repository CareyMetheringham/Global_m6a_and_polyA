...
bam_list <- dir_ls("/Volumes/cluster/ggs_lab/mtparker/papers/flacc/flacc_nanopore/pipeline/aligned_data", glob = "*.bam")  %>%
  str_subset("col0")
...
apa_results <- apa_results[apa_results$wass_fdr < 0.01,]
